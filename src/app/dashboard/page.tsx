  ...
  return (
    <div className="min-h-screen bg-[#F8F1E6] text-[#111111] selection:bg-[#B42318] selection:text-white">
      ...
      <main className="pb-20 px-4 sm:px-8 max-w-7xl mx-auto space-y-12 pt-12">
        ...
        {/* ── 6. Real Footer ── */}
        <footer className="mt-16 bg-[#111111] text-[#F8F1E6] rounded-[32px] overflow-hidden relative shadow-2xl">
          {/* Top section */}
          <div className="px-10 sm:px-14 pt-14 pb-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
              {/* Brand column */}
              <div className="lg:col-span-2">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-[#B42318] flex items-center justify-center font-black text-white text-lg">♫</div>
                  <div>
                    <p className="text-base font-black uppercase font-mono tracking-tight">RHYTHM OF INDIA</p>
                    <p className="text-[10px] text-[#777777] uppercase tracking-widest">Classical Dance Academy</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <a
                    ...
                    className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-[#B42318] hover:border-[#B42318] transition-all"
                  >
                  ...
                  <a
                    href="https://www.youtube.com/@rhythmofindia"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              {/* Support + GitHub */}
              <div>
                <h5 className="text-[11px] font-bold text-[#777777] uppercase tracking-widest font-mono mb-4">Links</h5>
                <ul className="space-y-3 text-sm text-gray-300 font-medium">
                  <li>
                    <a
                      href="https://github.com/heyaurav01/Rhythmdance"
                ...
                {/* SIH 2026 badge */}
                <div className="mt-6 inline-flex items-center gap-2 bg-[#B42318]/20 border border-[#B42318]/40 text-[#B42318] px-3 py-1.5 rounded-lg text-[11px] font-bold font-mono">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#B42318] animate-pulse" />
                  SIH 2026 Prototype
                </div>
              </div>
            </div>
          ...
          {/* Bottom bar */}
          <div className="px-10 sm:px-14 py-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-3">
            <p className="text-[11px] text-[#555555] font-mono">© 2026 Rhythm of India. All rights reserved. Built for Smart India Hackathon 2026.</p>
            <a
              href="https://github.com/heyaurav01/Rhythmdance"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[11px] text-[#555555] hover:text-[#B42318] font-mono transition-colors flex items-center gap-1.5"
            >
          ...
          {/* Watermark */}
          <div className="absolute left-1/2 -translate-x-1/2 bottom-[-10%] text-[18vw] leading-none font-black font-sans text-white/[0.025] tracking-tighter pointer-events-none select-none z-0 whitespace-nowrap">
            rhythmofindia
          </div>
        </footer>
      </main>
